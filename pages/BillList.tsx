                            ...
                            {bills.map((bill) => (
                                <tr key={bill.billId} className="hover:bg-cyan-50 transition-colors">
                                    ...
                                    <td className="px-4 py-3 whitespace-nowrap text-sm font-medium space-x-2">
                                        <button className="text-cyan-600 hover:text-cyan-900 font-medium">View</button>
                                        <button className="text-green-600 hover:text-green-900 ml-2 font-medium">Print</button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
